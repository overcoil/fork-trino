        ...
        extends AbstractDeltaDistributedQueryTestBase
{
    ...
    @Test
    void readSpecificSnapshotVersion()
    {
        ...
        // All snapshots are created at 2020-10-26 02:52:47.515
        ...
        // All snapshots are created at 2020-10-26 02:52:47.515
        // read snapshot as of 2020-10-26 02:52:48 - this should read the latest data
        String testQueryTs2 = format(testQueryTemplate, deltaTable, "t2020-10-26 02:52:48");
        String expResultsQueryTs2 = "SELECT * FROM VALUES(0, 'data-2-0'), (0, 'data-3-0')";
        assertDeltaQuery(deltaTable, testQueryTs2, expResultsQueryTs2);
    }

    @Test
    void readCheckpointedDeltaTable()
    {
