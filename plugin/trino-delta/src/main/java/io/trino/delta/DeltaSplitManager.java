        ...
        implements ConnectorSplitManager
{
            ...
            implements ConnectorSplitSource
    {
        ...
        DeltaSplitSource(ConnectorSession session, DeltaTableHandle deltaTableHandle)
        {
            ...
            this.fileIter = DeltaExpressionUtils.iterateWithPredicate(
                    session,
        ...
        public CompletableFuture<ConnectorSplitBatch> getNextBatch(ConnectorPartitionHandle partitionHandle, int maxSize)
        {
            ...
            while (fileIter.hasNext() && splits.size() < maxSize && splits.size() < maxBatchSize) {
                AddFile file = fileIter.next();
            ...
            return completedFuture(new ConnectorSplitBatch(splits, !fileIter.hasNext()));
        }
